...
public class ElasticsearchRoutingStrategyV5Test {
	...
	public void setUp() throws Exception {
		// Note: this could be randomly generated, but if a test is to fail we want it to fail consistently
	...
	public void testOrgOn7ShardsHashes() {
		...
		ElasticsearchRoutingStrategyV5 strategy = new ElasticsearchRoutingStrategyV5();
	...
	public void testOrgDistribution() {
		...
		Set<String> routingHashs = new HashSet<>();
		for(String orgId : orgIds) {
			routingHashs.add(strategy.getRoutingHash(orgId));
		}
